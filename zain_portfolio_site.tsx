...
import { Menu, X, Github, Linkedin, Youtube, Facebook, Mail, MapPin, ChevronRight, Code, Cpu, Zap, MessageCircle } from 'lucide-react';
  ...
  const projects = [
    {
      ...
      description: 'Built an autonomous agent system using n8n and Claude API for document processing and analysis.',
      tech: ['n8n', 'Claude API', 'Python']
    },
    {
      category: 'SaaS',
      title: 'Task Automation Platform',
      description: 'Developed a comprehensive automation platform for businesses to streamline operations.',
      tech: ['React', 'Node.js', 'PostgreSQL']
    },
    {
      category: 'Integration',
      title: 'GHL Marketing Suite',
      description: 'Custom GoHighLevel integration suite for automated client onboarding and campaigns.',
      tech: ['GHL API', 'JavaScript', 'Webhooks']
    }
  ];
  ...
  const testimonials = [
    {
      ...
      text: 'Zain transformed our workflow with intelligent automation. Our team productivity increased by 300%.'
    },
    {
      name: 'Michael Chen',
      role: 'Startup Founder',
      text: 'The AI agents Zain built have completely automated our customer support. Incredible work!'
    },
    {
      name: 'Emily Rodriguez',
      role: 'Agency Owner',
      text: 'Best GHL developer I have worked with. Delivered exactly what we needed and more.'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between border border-[#171A1F]/80 bg-[#050505]/85 backdrop-blur-md px-4 sm:px-5 md:px-6 py-3">
            <a href="#home" className="flex items-center gap-3 group">
              <div className="w-8 h-8 bg-gradient-to-br from-[#9ED8FF] to-[#CFAE6E] flex items-center justify-center">
                <span className="text-[#050505] font-bold" style={{ fontFamily: 'Michroma, sans-serif' }}>Z</span>
              </div>
            ...
            <div className="hidden lg:flex items-center border border-[#171A1F]/80 bg-[#0C0D10]/90">
              {navItems.map((item, i) => (
                <a
                  ...
                  className={`text-[10px] tracking-[0.18em] uppercase px-6 py-3 transition-colors duration-300 ${
            ...
            <a
              ...
              className="hidden lg:inline-flex items-center gap-3 border border-[#232833] bg-[#111318]/90 px-5 py-3 text-[10px] tracking-[0.18em] uppercase text-[#F5F7FA] transition-all duration-300 hover:border-[#CFAE6E]/60 hover:text-[#CFAE6E]"
              style={{ fontFamily: 'Michroma, sans-serif' }}
            >
            ...
            <button
              ...
              className="lg:hidden text-[#F5F7FA]"
            >
          ...
          {/* Mobile Menu */}
          {mobileMenuOpen && (
            <div className="lg:hidden mt-2 border border-[#171A1F]/80 bg-[#050505]/95 backdrop-blur-md">
              {navItems.map((item) => (
                <a
                  key={item.id}
                  href={`#${item.id}`}
                  ...
                  className="block text-[10px] tracking-[0.18em] uppercase text-[#B8C0CC] px-5 py-4 border-b border-[#171A1F]/80 hover:text-[#CFAE6E]"
                  style={{ fontFamily: 'Michroma, sans-serif' }}
                >
                  {item.label}
                </a>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 xl:grid-cols-12 gap-10 xl:gap-12 items-end">
          ...
          <div className="xl:col-span-8 flex flex-col justify-end min-w-0 relative z-20 pt-10 md:pt-16 xl:pt-0">
            ...
            <h1 className="uppercase leading-[0.9] tracking-[-0.065em] mb-7 md:mb-8" style={{ fontFamily: 'Michroma, sans-serif' }}>
              ...
              <span className="block text-[2.55rem] sm:text-[3.6rem] md:text-[4.7rem] lg:text-[5.8rem] xl:text-[6.6rem] bg-gradient-to-r from-[#9ED8FF] via-[#74C7FF] to-[#C8EAFF] bg-clip-text text-transparent">
                Irshad
              </span>
            </h1>

            <p className="text-[#AEB8C6] text-[0.95rem] sm:text-[1rem] md:text-base max-w-[42rem] font-light leading-relaxed">
            ...
            <div className="md:mt-10 mt-8 relative flex flex-col sm:flex-row gap-4">
              <a
                href="#portfolio"
                className="inline-flex items-center justify-center gap-4 border border-[#232833] bg-[#0C0D10]/90 px-5 md:px-7 py-3.5 md:py-4 text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#F5F7FA] transition-all duration-300 hover:border-[#CFAE6E]/60 hover:text-[#CFAE6E]"
                style={{ fontFamily: 'Michroma, sans-serif' }}
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-3 border border-[#171A1F] bg-transparent px-5 md:px-7 py-3.5 md:py-4 text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#B8C0CC] transition-all duration-300 hover:border-[#9ED8FF]/40 hover:text-[#9ED8FF]"
                style={{ fontFamily: 'Michroma, sans-serif' }}
              >
          ...
          {/* Right Metadata */}
          <div className="xl:col-span-4 flex justify-end relative z-10 mt-10 md:mt-0">
            <div className="relative w-full max-w-[25rem] md:max-w-[21rem] xl:max-w-[24.5rem] border border-[#171A1F]/80 bg-[#090B0E]/45 backdrop-blur-[2px] px-5 py-5 md:px-6 md:py-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start justify-between gap-6 border-b border-[#171A1F]/70 pb-3">
                  <span className="text-[9px] uppercase tracking-[0.16em] text-[#7D8794] pt-0.5" style={{ fontFamily: 'Michroma, sans-serif' }}>
                    Location
                  </span>
                  <span className="text-[12px] md:text-[13px] text-[#E4EBF4] tracking-[0.08em] uppercase text-right">
                    Multan, Pakistan
                  </span>
                </div>

                <div className="flex items-start justify-between gap-6 border-b border-[#171A1F]/70 pb-3">
                  <span className="text-[9px] uppercase tracking-[0.16em] text-[#7D8794]" style={{ fontFamily: 'Michroma, sans-serif' }}>
                    Availability
                  </span>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                    <span className="text-[12px] md:text-[13px] text-[#BFD8EE] tracking-[0.08em] uppercase">
                      Available
                    </span>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 xl:gap-14">
            ...
            <div className="xl:col-span-9">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 max-w-5xl">
                ...
                <p className="text-[#9AA6B5] text-[1rem] md:text-[1.05rem] leading-[1.9] font-light">
                  With 488+ connections on LinkedIn and a growing portfolio of successful projects, I help businesses transform their operations through intelligent automation and custom AI solutions.
                </p>
              </div>

              <div className="mt-10 flex flex-wrap gap-3">
                {['Python', 'n8n', 'Claude API', 'GHL', 'React', 'Node.js', 'AI Agents', 'Automation'].map(skill => (
                  <span
                    key={skill}
                    className="border border-[#171A1F] bg-[#0C0D10]/50 px-4 py-2 text-[10px] uppercase tracking-[0.16em] text-[#9ED8FF]"
                    style={{ fontFamily: 'Michroma, sans-serif' }}
                  >
                    {skill}
                  </span>
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {services.map((service, i) => (
              <div
                key={i}
                className="group relative overflow-hidden bg-[#050505] border border-[#171A1F] p-6 transition-all duration-500 hover:border-[#9ED8FF]/30"
              >
                <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#9ED8FF]/30 to-transparent"></div>
                <div className="text-[#9ED8FF] mb-4">{service.icon}</div>
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {projects.map((project, i) => (
              <div
                key={i}
                className="group relative overflow-hidden bg-[#050505] border border-[#171A1F] transition-all duration-500 hover:border-[#9ED8FF]/30"
              >
                <div className="p-6">
                  <div className="flex items-center justify-between mb-2">
                    <span className="border border-[#9ED8FF]/30 bg-[#9ED8FF]/10 px-2 py-1 text-[10px] uppercase tracking-widest text-[#9ED8FF]" style={{ fontFamily: 'Michroma, sans-serif' }}>
                      {project.category}
                    </span>
                  </div>
                  <h3 className="text-lg uppercase tracking-tight text-[#F5F7FA] mt-4 mb-3" style={{ fontFamily: 'Michroma, sans-serif' }}>
                    {project.title}
                  </h3>
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {testimonials.map((testimonial, i) => (
              <div
                key={i}
                className="border border-[#171A1F]/80 bg-[#050505]/45 backdrop-blur-[2px] p-6"
              >
                <p className="text-[#B8C0CC] text-sm leading-relaxed mb-6 italic">
                  "{testimonial.text}"
                </p>
                <div className="border-t border-[#171A1F]/70 pt-4">
                  <p className="text-[#F5F7FA] font-medium">{testimonial.name}</p>
                  <p className="text-[#7D8794] text-xs uppercase tracking-wider mt-1" style={{ fontFamily: 'Michroma, sans-serif' }}>
                    {testimonial.role}
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
              <a
                ...
                className="border border-[#171A1F]/80 bg-[#0C0D10]/50 p-6 hover:border-[#9ED8FF]/30 transition-all duration-300"
              >
                <Mail className="w-6 h-6 text-[#9ED8FF] mx-auto mb-3" />
                <p className="text-[10px] uppercase tracking-wider text-[#7D8794] mb-2" style={{ fontFamily: 'Michroma, sans-serif' }}>Email</p>
                <p className="text-[#F5F7FA]">zainirshad307@gmail.com</p>
              </a>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-4 border border-[#232833] bg-[#0C0D10]/90 px-6 md:px-7 py-4 text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#F5F7FA] transition-all duration-300 hover:border-[#CFAE6E]/60 hover:text-[#CFAE6E]"
                style={{ fontFamily: 'Michroma, sans-serif' }}
              >
                <span className="flex items-center gap-3">
                  <span className="w-1.5 h-1.5 bg-[#9ED8FF]"></span>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 border border-[#171A1F] bg-transparent px-6 md:px-7 py-4 text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-[#B8C0CC] transition-all duration-300 hover:border-[#9ED8FF]/40 hover:text-[#9ED8FF]"
                style={{ fontFamily: 'Michroma, sans-serif' }}
              >
                <span>View LinkedIn</span>
              </a>
            ...
            <div className="mt-10 flex items-center justify-center gap-6">
              <a href="https://github.com/M-Zain-ai" target="_blank" rel="noopener noreferrer" className="text-[#7D8794] hover:text-[#9ED8FF] transition-colors">
                <Github size={20} />
              </a>
              <a href="https://www.linkedin.com/in/aizain/" target="_blank" rel="noopener noreferrer" className="text-[#7D8794] hover:text-[#9ED8FF] transition-colors">
                <Linkedin size={20} />
              </a>
              <a href="https://www.youtube.com/@zainirshad9412" target="_blank" rel="noopener noreferrer" className="text-[#7D8794] hover:text-[#9ED8FF] transition-colors">
                <Youtube size={20} />
              </a>
              <a href="https://www.facebook.com/muhammad.zain.955512" target="_blank" rel="noopener noreferrer" className="text-[#7D8794] hover:text-[#9ED8FF] transition-colors">
                <Facebook size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-[10px] uppercase tracking-[0.16em] text-[#4A505C]" style={{ fontFamily: 'Michroma, sans-serif' }}>
              © 2026 Zain Irshad. All Rights Reserved.
            </p>
            <div className="flex gap-6">
              <a href="#" className="text-[10px] uppercase tracking-[0.16em] text-[#4A505C] hover:text-[#9ED8FF]">Privacy</a>
              <a href="#" className="text-[10px] uppercase tracking-[0.16em] text-[#4A505C] hover:text-[#9ED8FF]">Terms</a>
            </div>
          </div>
        </div>
      </footer>
